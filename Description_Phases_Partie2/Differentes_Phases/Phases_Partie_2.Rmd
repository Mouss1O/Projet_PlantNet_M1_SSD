...
**Données :** Données synthétiques (artificielles) générées avec `sklearn.datasets.make_classification`
...
Générer 10 000 points (observations) avec `sklearn.datasets.make_classification` ($N=10 000$ observations, 2 variables explicatives ($X_1$, $X_2$) et 10 classes)
...
- Implémenter une version où le seuil $\hat{q}$ change selon le score softmax de l'IA.
