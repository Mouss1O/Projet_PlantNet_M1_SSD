...
# CHEMINS
# ================================================================
BASE       = r"C:\Users\SCD-UM\Documents\Projet_PlantNet_M1_SSD\Données"
...
# ================================================================
# 1. ai_scores_all.json vers CSV (STREAMING pour gros fichier)
# ================================================================
def convert_ai_scores_streaming(json_path, csv_path):
    """
    Parse un gros JSON en streaming.
    Structure : { "obs_id": { "species_id": score, ... } }
    """
